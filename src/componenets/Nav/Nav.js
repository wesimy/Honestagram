                ...
                (!isAuth) ?
                    ...
                    (
                        <ul className="uk-iconnav uk-flex uk-flex-middle">
                            ...
                            <li><Link to={routes.settings}  uk-tooltip={'title: Account Settings;delay: 250;animation: uk-animation-slide-bottom-small'}><div className="uk-border-circle"><img className="uk-border-circle" src={account.photoURL} alt={account.displayName} /></div></Link></li>
