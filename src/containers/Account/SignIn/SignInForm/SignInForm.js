    ...
    render() {
        ...
        return (
            <div className="uk-flex-center uk-flex">
                <div className="uk-width-medium sign-in-form">
                    ...
                    <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                        <fieldset className="uk-fieldset">
                            <div className="uk-margin">
                                <Field className="uk-input" icon="user" name="email" type="email" placeholder="Email" component={renderInput} />
                            </div>
                            <div className="uk-margin">
                                <Field className="uk-input" icon="lock" name="password" type="password" placeholder="Password" component={renderInput} />
                            </div>
                        </fieldset>
                        <button className="uk-button button-accent" type="submit" disabled={submitting}>Login</button>
                    </form>
